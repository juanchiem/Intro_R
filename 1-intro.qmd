...
\- ejecutemos `plot(pressure)` y guardemos el gráfico resultante en la carpeta correspondiente.
...
\- ejecutemos `data(pressure)` y guardemos esos datos en su carpeta correspondiente `write.csv("data/pressure.csv")`
:::
